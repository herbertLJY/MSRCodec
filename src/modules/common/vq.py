...
class VectorQuantize(Module):
    def __init__(
        ...
        return_zeros_for_masked_padding = True, **unused
    ):
        super().__init__()
    ...
    def embed_code(self, embed_id):
        return self.get_codes_from_indices(embed_id)

    def get_embedding_from_code(self, embed_id):
        codes = self.get_codes_from_indices(embed_id)
        return self.project_out(codes)
